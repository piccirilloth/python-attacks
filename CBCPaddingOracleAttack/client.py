...
def guess_byte(p,c,ciphertext,block_size):
    ...
    for i in range(0,256):
        ...
        if response == b'OK':
            ...
            p_prime = padding_value ^ i #in this way we have found the decryption of the byte of the Ci block
            plain = bytes([p_prime ^ ciphertext[current_byte_index]]) # to obtain the final decrypted byte we XOR Ci-1 and p_prime
